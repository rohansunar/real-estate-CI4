...
<section class="position-relative py-5 bg-primary text-white" style="margin-top: 76px;">
    <div class="container py-5">
        <div class="row align-items-center">
            <div class="col-lg-8">
                <h1 class="display-4 fw-bold mb-4">Real Estate Blog</h1>
                <p class="fs-5 mb-0">
                    Stay updated with the latest trends, tips, and insights from the Siliguri real estate market.
                </p>
            </div>
            <div class="col-lg-4">
                <div class="text-center">
                    <i class="fas fa-blog display-1 text-white opacity-75"></i>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-8">
                        ...
                        <nav aria-label="Blog pagination" class="mt-5">
                            <ul class="pagination justify-content-center">
                                ...
                                <?php if ($currentPage > 1): ?>
                                    <li class="page-item">
                                        <a class="page-link" href="<?= base_url('blog?page=' . ($currentPage - 1)) ?>">
                                ...
                                if ($startPage > 1): ?>
                                    <li class="page-item">
                                        <a class="page-link" href="<?= base_url('blog?page=1') ?>">1</a>
                                    </li>
                                    <?php if ($startPage > 2): ?>
                                        <li class="page-item disabled">
                                ...
                                <?php if ($endPage < $totalPages): ?>
                                    ...
                                    <?php endif; ?>
                                    <li class="page-item">
                                        <a class="page-link" href="<?= base_url('blog?page=' . $totalPages) ?>"><?= $totalPages ?></a>
                                    </li>
                                <?php endif; ?>
                ...
                <?php else: ?>
                    ...
                    <div class="text-center py-5">
                        <i class="fas fa-blog display-1 text-muted mb-4"></i>
